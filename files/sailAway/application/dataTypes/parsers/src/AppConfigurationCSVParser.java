	...
	public void getData(boolean omitFirstLine)
	{
		...
		try(BufferedReader bufferedReader = new BufferedReader(new FileReader(inputFile))){
			...
			try{
				...
				if(trailLength <= 0) throw new NotAPositiveNumberException("Trail Length should be a positive number.");
				...
				System.out.println(npne.toString() + " Preserving the default Trail Length setting of " + AppConfiguration.getDefaultTrailLength() + " steps.");
			}
			// Lane Width
			try{
