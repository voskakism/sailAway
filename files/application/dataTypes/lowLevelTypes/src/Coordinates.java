class Coordinates
{
	...
	Coordinates(Coordinates point) // create a new object based on the current state of an existing one.
	{
	...
	public static double distanceOfPointPFromLineAB(Coordinates p, Coordinates a, Coordinates b)
	{
